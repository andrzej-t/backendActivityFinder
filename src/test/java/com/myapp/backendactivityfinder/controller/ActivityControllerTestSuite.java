...
public class ActivityControllerTestSuite {
    ...
    @Test
    public void testShouldGetRandomActivities() throws Exception {
        ...
        when(activityFacade.showRandomAct()).thenReturn(activityList);
    ...
    @Test
    public void testShouldGetNameActivities() throws Exception {

        //Given
        List<Activity> activityList = new ArrayList<>();
        activityList.add(new Activity(1L, "testName1", "testDescription1", 10, 60, true, true, true, true, true, true, true, true, true, true, true, true));
        when(activityFacade.showNameAct()).thenReturn(activityList);

        //When & Then
        mockMvc.perform(get("/v1/name")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is(200))
                .andExpect(jsonPath("$", hasSize(1)))
                .andExpect(jsonPath("$[0].id", is(1)))
